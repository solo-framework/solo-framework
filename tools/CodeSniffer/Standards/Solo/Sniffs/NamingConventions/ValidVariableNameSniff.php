 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Solo_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
	...
	protected function processMemberVar (PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		// не подчеркиваем приватные мемберы
		//
		...
		if ($isPublic === true &&
		 $scopeSpecified === true && $memberName{0} === '_')
		{
