 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Solo_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
	/**
	 ...
	 * @var array
	 */
	protected $magicMethods = array('construct', 'destruct', 'call', 'callStatic', 'get', 'set', 'isset', 'unset', 
	'sleep', 'wakeup', 'toString', 'set_state', 'clone');
	/**
	...
	protected function processTokenWithinScope (PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
	{
		...
		// приватные методы не начинаются с подчеркивания
		...
		if ($isPublic === true && $scopeSpecified ===
		 true && $methodName{0} === '_')
		{
		...
		// считаем, что все методы публичные. т.к.
		// нет разницы в оформлении методов с разными модификаторами доступа
