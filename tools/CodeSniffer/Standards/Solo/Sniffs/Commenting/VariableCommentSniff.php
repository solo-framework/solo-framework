<?php
/**
 * Проверка комментариев переменных класса
 * 
 * @version $Id: ProfileManager.php 29 2008-01-24 13:04:43Z afi $
 * @author Andrey Filippov
 */
class Solo_Sniffs_Commenting_VariableCommentSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
	/**
...
//				}
			...
			// комментарии к переменным могут быть многострочными
...
//			}
			...
			// точка в  конце строки необязательна
//			if ($lastChar !== '.')
//			{
...
//			}
		...
		// не проверяем наличие тега @since
	...
	protected function processVar ($commentStart, $commentEnd)
	{
		...
		if ($var !== null)
		{
			...
			// не проверяем отступы между @tag и текстом
